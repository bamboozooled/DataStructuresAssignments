...
public class GraphAlgorithms {
  ...
  shortestPathLengths(Graph<V,Integer> g, Vertex<V> src, Vertex<V> to) {
      ...
      for (Edge<Integer> e : g.outgoingEdges(u)) {
        ...
        if (cloud.get(v) == null) {
          ...
          if (d.get(u) + wgt < d.get(v)){
            if (v.getElement() == to.getElement()){
              if (!all.contains(String.valueOf(v.getElement()))){
                String h = String.valueOf(u.getElement());
                all.add(h);
                System.out.print(v.getElement() + " ");
                System.out.print(u.getElement() + " ");
              }
              shortestPathLengths(g, src, u);  
            }              // better path to v?
